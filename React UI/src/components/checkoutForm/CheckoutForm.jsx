//Handles the Stripe payment form and its submission.
...
const CheckoutForm = () => {
  ...
  // State variables for email, message, and loading status
  const [email, setEmail] = useState("");
  const [message, setMessage] = useState(null);
  const [isLoading, setIsLoading] = useState(false); // if it is loadi

   // useEffect to handle payment intent retrieval and status
  useEffect(() => {
    if (!stripe) {
      return;
    }
